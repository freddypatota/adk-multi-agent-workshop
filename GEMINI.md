...
```python
import vertexai
client = vertexai.Client(location="europe-west3")
...
gcloud pubsub subscriptions create my-sub --topic=my-topic \
    --push-endpoint=https://loan-drawdown-agent-demo.run.app/invoke
# Eventarc trigger
gcloud eventarc triggers create my-trigger \
    --destination-run-service=loan-drawdown-agent-demo \
